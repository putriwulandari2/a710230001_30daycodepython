class Buah:
    ...
    def update_harga(self, harga_baru):
        ...
        print(f"Harga {self.nama} diperbarui menjadi Rp.{self.harga_per_kg} per kg.")
    ...
    def informasi_buah(self):
        ...
        print(f"Harga per kg: Rp.{self.harga_per_kg}")
...
nanas = Buah("Nanas", 15000, 50)
alpukat = Buah("Alpukat", 20000, 30)
kiwi = Buah("Kiwi", 25000, 40)
...
print(f"Total nilai stok buah di {toko_buah.nama_toko}: Rp.{total_nilai}")
